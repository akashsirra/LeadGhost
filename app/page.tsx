...
export default function Home() {
  return <main className="min-h-screen overflow-hidden">
    <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-6 md:px-8">
      ...
      <div className="flex items-center gap-2"><Link href="/grok" className="rounded-full bg-white px-4 py-2 text-sm font-medium text-black hover:bg-[#ddd]">Open GHOST →</Link><Link href="/app" className="rounded-full border border-[#333339] px-4 py-2 text-sm hover:bg-white/5">Open console →</Link></div>
    </nav>
    ...
    <section className="grid-bg mx-auto max-w-6xl px-5 pb-24 pt-16 text-center md:px-8 md:pt-28">
      ...
      <div className="mx-auto mt-9 flex max-w-xl flex-col gap-3 sm:flex-row"><Link href="/grok" className="glow flex-1 rounded-xl bg-white px-6 py-4 font-semibold text-black">Try GHOST →</Link><Link href="/app" className="flex-1 rounded-xl border border-[#303037] px-6 py-4 font-medium">Enter AEGIS →</Link></div>
